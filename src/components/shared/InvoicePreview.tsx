...
export const InvoicePreview: React.FC<InvoicePreviewProps> = ({ invoice }) => {
  ...
  const statusColors = {
    ...
    processing: 'border-pixel-navy-900 text-brand-teal/20',
    waiting: 'border-yellow-500 text-functional-warning/20',
    rejected: 'border-red-600 text-functional-error/20',
    canceled: 'border-pixel-neutral-500 text-brand-grayBlue/20',
  };

  return (
    <div className="relative w-full border border-pixel-neutral-200 rounded-premium bg-white p-6 md:p-8 shadow-premium text-pixel-neutral-900 font-sans overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col gap-6">
        ...
        {/* Header Grid */}
        <div className="flex flex-col md:flex-row justify-between gap-6 border-b border-pixel-neutral-200 pb-6">
          ...
          <div className="flex flex-col md:items-end gap-1">
            <span className="text-xs font-semibold text-pixel-neutral-500 uppercase tracking-wide">
              {invoice.type} - Nota Fiscal Eletrônica
            </span>
            <span className="text-lg font-bold text-pixel-navy-900">
              Nº {cleanNumber}
            </span>
        ...
        {/* Access Key */}
        <div className="bg-pixel-neutral-100 p-3.5 rounded-soft border border-pixel-neutral-200 text-xs flex flex-col gap-1">
          <span className="font-semibold text-pixel-navy-900 uppercase tracking-wider text-[10px]">
            Chave de Acesso (44 dígitos)
          </span>
          <span className="font-mono text-pixel-neutral-900 select-all tracking-wider md:text-sm text-xs">
            {cleanKey}
          </span>
        </div>

        {/* Emitente & Destinatário */}
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 border-b border-pixel-neutral-200 pb-6">
          {/* Emitente */}
          <div className="flex flex-col gap-2 text-xs">
            <h4 className="font-bold text-pixel-navy-900 font-title uppercase tracking-wider text-[10px]">
              Prestador de Serviços / Emitente
            </h4>
            <div className="flex flex-col gap-1 text-pixel-neutral-500">
              <span className="font-bold text-pixel-neutral-900">{issuer.name}</span>
          ...
          <div className="flex flex-col gap-2 text-xs">
            ...
            <div className="flex flex-col gap-1 text-pixel-neutral-500">
              <span className="font-bold text-pixel-neutral-900">{invoice.clientName}</span>
        ...
        {/* Itens */}
        <div className="flex flex-col gap-2">
          <h4 className="font-bold text-pixel-navy-900 font-title uppercase tracking-wider text-[10px] mb-1">
            Descrição dos Produtos / Serviços
          </h4>
          <div className="overflow-x-auto border border-pixel-neutral-200 rounded-soft">
                ...
                {invoice.items.map((item, idx) => {
                  ...
                  return (
                    <tr key={idx} className="hover:bg-neutral-bgSecondary/20">
                      <td className="p-3 font-medium text-pixel-neutral-900">{item.description}</td>
                      {invoice.type === 'NFS-e' ? (
                        <td className="p-3 text-pixel-neutral-500 font-mono">{item.cnae || '6201-5/01'}</td>
                      ) : (
                        <>
                          <td className="p-3 text-pixel-neutral-500 font-mono">{item.ncm || '4820.10.00'}</td>
                          <td className="p-3 text-pixel-neutral-500 font-mono">{item.cfop || '5.102'}</td>
                        </>
                      )}
                      ...
                      <td className="p-3 text-right font-semibold text-pixel-navy-900">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 pt-4 border-t border-pixel-neutral-200">
          {/* Tributos */}
          <div className="md:col-span-2 flex flex-col gap-2">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
              {invoice.type === 'NFS-e' ? (
                <>
                  <div className="bg-neutral-bgSecondary/50 p-2 rounded border border-pixel-neutral-200 text-xs">
                    <span className="text-pixel-neutral-500 block text-[10px]">ISS</span>
                    <span className="font-bold text-pixel-navy-900">
                      {invoice.taxes.iss 
                  ...
                  <div className="bg-neutral-bgSecondary/50 p-2 rounded border border-pixel-neutral-200 text-xs">
                    <span className="text-pixel-neutral-500 block text-[10px]">IRRF</span>
                    <span className="font-bold text-pixel-navy-900">
                      {invoice.taxes.ir 
                  ...
                  <div className="bg-neutral-bgSecondary/50 p-2 rounded border border-pixel-neutral-200 text-xs">
                    <span className="text-pixel-neutral-500 block text-[10px]">CSLL</span>
                    <span className="font-bold text-pixel-navy-900">
                      {invoice.taxes.csll 
                  ...
                  <div className="bg-neutral-bgSecondary/50 p-2 rounded border border-pixel-neutral-200 text-xs">
                    <span className="text-pixel-neutral-500 block text-[10px]">INSS</span>
                    <span className="font-bold text-pixel-navy-900">
                      {invoice.taxes.inss 
                ...
                <>
                  <div className="bg-neutral-bgSecondary/50 p-2 rounded border border-pixel-neutral-200 text-xs">
                    <span className="text-pixel-neutral-500 block text-[10px]">ICMS</span>
                    <span className="font-bold text-pixel-navy-900">
                      {invoice.taxes.icms 
                  ...
                  <div className="bg-neutral-bgSecondary/50 p-2 rounded border border-pixel-neutral-200 text-xs">
                    <span className="text-pixel-neutral-500 block text-[10px]">PIS</span>
                    <span className="font-bold text-pixel-navy-900">
                      {invoice.taxes.pis 
                  ...
                  <div className="bg-neutral-bgSecondary/50 p-2 rounded border border-pixel-neutral-200 text-xs">
                    <span className="text-pixel-neutral-500 block text-[10px]">COFINS</span>
                    <span className="font-bold text-pixel-navy-900">
          ...
          {/* Valor Total */}
          <div className="bg-pixel-navy-900 text-white p-4 rounded-soft flex flex-col justify-center items-end gap-1 shrink-0 shadow-sm border border-pixel-navy-950">
            <span className="text-[10px] font-bold uppercase tracking-wider text-pixel-navy-900">
              VALOR TOTAL DA NOTA
            </span>
        ...
        {invoice.observations && (
          <div className="bg-neutral-bgSecondary/50 p-3 rounded-soft border border-pixel-neutral-200 text-[11px] flex flex-col gap-1 mt-2">
            <span className="font-bold text-pixel-navy-900 uppercase tracking-wider text-[9px]">
              Informações Complementares / Observações Fiscais
            </span>
            <p className="text-pixel-neutral-500 leading-relaxed">
              {invoice.observations}
            </p>
          </div>
        )}
