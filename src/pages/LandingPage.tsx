    ...
    <div className="flex flex-col w-full bg-surface">
      ...
      <section className="pt-36 pb-20 px-6 md:px-12 lg:px-24 flex flex-col lg:flex-row items-center gap-12 max-w-7xl mx-auto w-full">
        ...
        <div className="flex-1 w-full flex flex-col items-center relative select-none">
          ...
          <div className="absolute bottom-[-20px] right-[20px] md:right-[50px] bg-black border border-brand-blue/30 text-white p-4 rounded-premium shadow-premium-hover flex items-center gap-3 max-w-[260px] z-20 animate-bounce">
            <div className="p-2.5 bg-black rounded-soft text-white">
